  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3 mb-3">
        <Link href={`/kullanici/${review.userHandle.replace('@', '')}`} className="relative flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <Link href={`/kullanici/${review.userHandle.replace('@', '')}`} className="font-semibold text-sm text-white hover:text-indigo-300 transition-colors">{review.userName}</Link>
